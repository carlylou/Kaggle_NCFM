...
# Note that the preprocessing of ResNet50 is:
# (x / 255 - 0.5) x 2

print('Adding Average Pooling Layer and Softmax Output Layer ...')
output = ResNet50_notop.get_layer(index = -1).output  # Shape: (1, 1, 2048)
#output = AveragePooling2D((7, 7), name='avg_pool')(output)
...
# autosave best Model
best_model_file = "./ResNet50_weights.h5"
